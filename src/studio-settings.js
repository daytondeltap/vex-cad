...
function updateFooter(){const footer=document.querySelector('footer span:last-child');if(!footer)return;footer.textContent=settings.controlsPreset==='roblox'?`${prettyKey(settings.bindings.cycleTransform)} cycle tool · RMB look · WASD fly · Ctrl/Cmd+Shift+A align`:'Ctrl/Cmd+click multi-select · Ctrl/Cmd+Shift+A Auto Align · M/R transform';}
