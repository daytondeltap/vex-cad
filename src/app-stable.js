...
function newProject(){if(autoAlign)cancelAutoAlign(true);state.projectName='Untitled';state.entities.clear();state.constraints=[];state.selection.clear();state.customGeometries.clear();history.clear();$('projectName').textContent=state.projectName;cancelPlacement();scheduleSync();}
